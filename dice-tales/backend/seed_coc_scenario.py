  ...
  payload: dict[str, Any] = {
    ...
    "extensions": {
      ...
      "docx_seed": {
        ...
        "source_path": str(resolved_docx_path),
...
def write_seed_scenario_to_system(
  ...
  try:
    ...
    draft = backend_main.normalize_structured_module(MODULE_ID, scenario, SOURCE_TYPE, "draft")
    published = backend_main.normalize_structured_module(MODULE_ID, scenario, SOURCE_TYPE, "published")
