...
import {
  ...
  LOCAL_BETA_ACCESS_BYPASS_HEADER,
...
export function middleware(request: NextRequest) {
  ...
  if (isProtectedPlayerPath(request.nextUrl.pathname)) {
    ...
    requestHeaders.set(BETA_ACCESS_STATE_HEADER, localBypass || hasBetaAccessCookie ? "verified" : "unverified");
    requestHeaders.set(LOCAL_BETA_ACCESS_BYPASS_HEADER, localBypass ? "enabled" : "disabled");
  }
