...
export const COC_OCCUPATION_DETAILS: Record<string, CocOccupationDetail> = {
  私家侦探: { skills: ["艺术/手艺", "乔装", "法律", "图书馆利用", "聆听", "心理学", "侦查"], creditRating: [9, 30], pointFormula: "EDU*2+(STR|DEX)*2" },
  教授: { skills: ["图书馆利用", "其他语言", "母语", "心理学", "外语"], creditRating: [20, 70], pointFormula: "EDU*4" },
  记者: { skills: ["艺术/手艺", "历史", "图书馆利用", "母语", "心理学"], creditRating: [9, 30], pointFormula: "EDU*4" },
  医生: { skills: ["急救", "医学", "拉丁语", "心理学", "科学"], creditRating: [30, 80], pointFormula: "EDU*4" },
  作家: { skills: ["艺术/手艺", "历史", "图书馆利用", "自然界", "外语", "心理学"], creditRating: [9, 30], pointFormula: "EDU*4" },
  古董商: { skills: ["估价", "艺术/手艺", "历史", "图书馆利用", "外语", "侦查"], creditRating: [30, 70], pointFormula: "EDU*4" },
  警察: { skills: ["斗殴", "射击", "急救", "法律", "心理学", "侦查"], creditRating: [9, 30], pointFormula: "EDU*2+(STR|DEX)*2" },
